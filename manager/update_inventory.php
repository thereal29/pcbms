<div class="modal fade" id="viewprodinventory-<?php echo $fetch['item_id']?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
                ...
                <input type="hidden" name="id" value="<?php echo $fetch['item_id']; ?>" />
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    <label class="control-label" for="name">Quantity Stock</label>
                                    <input type="number" class="form-control" id="qty_stock" style="text-transform: capitalize;" name="qty_stock" value="<?php echo $fetch['quantity_stock']?>" required>
                                </div>
                                <div class="form-group col-md-3">
                    ...
                    <div class="modal-footer">
                        <button  class="savebtn" name="updateInventory">Submit Form</button>
