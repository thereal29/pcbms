    ...
    <div class="modal-dialog">
        <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-plus"></i>   Add New Customer</h5>
                </div>
                <form action="index.php?page=add" class="form-horizontal" method="POST">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-8">
                                    ...
                                    <label style="font-size:10px">(11 Digits)</label>
                                </div>
                            </div>
                        </div>
                        <br>
                    ...
                    <div class="modal-footer">
                        <button  class="savebtn" name="addCustomer">Submit Form</button>
