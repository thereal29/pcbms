...
<div class="card_b">
        ...
        <div class="card-body">
            <table class="table table-bordered table-striped " style="width: 100%;">
                ...
                <tbody id="row_data"> 
                    <?php
                        $i = 1;
                        $query = mysqli_query($conn, "SELECT user_id, firstname, lastname, middlename,gender, username, e.employee_id,password, j.job_title, email, phone_number, hired_date, l.province, l.city
                        FROM users u
                        JOIN employee e ON e.employee_id= u.employee_id
                        JOIN location l on e.location_id = l.location_id
                        JOIN job j ON j.job_id=e.job_id
                        WHERE u.job_id=3") or die(mysqli_error());
    ...
    <div class="card_b">
        <div class="card-header">
            <strong><i class="bx bx-data"></i>  Manager's Data</strong>
        </div>
        <div class="card-body">
            <table id="datatableid" class="table table-bordered table-striped " style="width: 100%;">
                ...
                <tbody id="row_data"> 
                    <?php
                        ...
                        JOIN location l on e.location_id = l.location_id
                        JOIN job j ON j.job_id=e.job_id
                        WHERE u.job_id=1") or die(mysqli_error());
                        while($fetch = mysqli_fetch_array($query)){
                    ?>
                    <tr>
                        <th class="text-center"><?php echo $i++ ?></th>
        ...
        <div class="card-body">
            <table id="datatableid2" class="table table-bordered table-striped " style="width: 100%;">
                ...
                <?php
                        ...
                        JOIN location l on e.location_id = l.location_id
                        JOIN job j ON j.job_id=e.job_id
                        WHERE u.job_id=2") or die(mysqli_error());
                        while($fetch = mysqli_fetch_array($query)){
                    ?>
                    <tr>
                        <th class="text-center"><?php echo $i++ ?></th>
