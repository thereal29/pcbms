<div class="modal fade" id="updateuser-<?php echo $fetch['user_id'] ?>" style="overflow-y: scroll" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-edit"></i>   Update Teacher's Profile</h5>
            </div>
                ...
                <input type="hidden" name="eid" value="<?php echo $fetch['employee_id']; ?>" />
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <br>
                            <div class="form-group" style="width:100%;border-bottom:2px solid #05300e">
                            <h4><b>Employee's System Details </b></h4>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <br>
                                    <label class="col-sx-4 control-label" for="username ">Username</label>
                                     <input id="username" name="username" type="text" placeholder="Username" maxlength="12" class="form-control input-xs" value="<?php echo $fetch['username']?>" required>
                                </div>  
                                <div class="form-group col-md-6">
                                    <br>
                                    ...
                                    <?php if(!empty($fetch['password'])){?>
                                        ...
                                        <label style="font-size:10px">Please don't submit/leave it empty</label>
                                   <?php }else{?>
                    ...
                    <div class="modal-footer">
                        <button  class="savebtn" name="updateAccount">Submit Form</button>
